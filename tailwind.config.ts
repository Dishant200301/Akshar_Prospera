  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        premium: "0 25px 50px -12px rgba(0, 86, 179, 0.25)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        wordFadeInUp: {
          // For the AnimatedText component
          "0%": { opacity: "0", transform: "translateY(10px)" },
          "100%": { opacity: "1", transform: "translateY(0)" },
        },
		fadeInUp: {
      ...
      animation: {
        ...
        "pop-in": "popIn 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards",
        word: "wordFadeInUp 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards",
      },
