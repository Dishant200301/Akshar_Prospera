...
const HeroSection = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: 'Life insurance policies designed to safeguard your family\'s financial security, ensuring peace of mind for',
      location: ' generations to come',
      additionalText: '. Because your family deserves the best protection.',
    },
    {
      id: 3,
      image: '/3.png',
      ...
      description: 'Premium health insurance coverage that ensures quality healthcare access for you and your family across',
      location: ' North America',
      additionalText: '. Your health is your greatest wealth.',
    }
  ];
