...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen overflow-hidden pt-16" style={{
      ...
      {/* Removed dark overlay to restore background image opacity */}
          ...
          <div className="max-w-4xl sm:max-w-3xl lg:max-w-2xl">
            <div className="animate-fade-in">
              ...
              <div className="flex flex-row flex-wrap items-center justify-center gap-3 sm:gap-6">
                <button className="flex-1 sm:flex-none bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-3 sm:px-6 py-3 rounded-xl font-semibold hover:from-blue-500 hover:to-indigo-500 transition-all duration-200 inline-flex items-center justify-center shadow-lg text-sm sm:text-base">
