        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {services.map((service, index) => (
            <div key={index} className="group block perspective-1000">
              ...
              >
                <div 
                  className={`bg-gradient-to-br ${service.bgColor} rounded-2xl p-6 h-full border-2 border-gray-200 transition-all duration-300 ease-out transform-gpu group-hover:shadow-2xl group-hover:scale-105`}
                  style={{
