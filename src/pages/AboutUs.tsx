      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">Building trust through transparency, integrity, and unwavering commitment to your family's protection.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {values.map((v, i) => (
              <div key={i} className="p-8 rounded-2xl border-2 border-gray-200 bg-white shadow-card">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 text-white flex items-center justify-center mb-4">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Experience the difference of personalized insurance solutions backed by 15+ years of expertise and genuine care for your family's future.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Discover how our founder's expertise transforms complex insurance decisions into simple, confident choices for your family.
              </p>
            </div>
                ...
                <div className="px-6 md:px-10 pt-8 pb-6">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    ...
                    <div className="flex items-center gap-6">
                      <div className="w-28 h-28 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-full p-2 shadow-xl ring-4 ring-gray-100">
                        <div className="w-full h-full rounded-full bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center text-white text-4xl font-bold">AI</div>
                      </div>
                      <div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 md:justify-end">
                      <button className="bg-white text-transparent bg-clip-text border-2 border-blue-600 px-6 py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-600 hover:text-white hover:bg-gradient-to-r transition-all duration-200 inline-flex items-center justify-center shadow-sm">
              ...
              <div className="px-6 md:px-10 pt-8 pb-10">
                ...
                <div className="grid grid-cols-3 gap-6 mb-10">
                  <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl p-6 text-center border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-1">15+</div>
                  ...
                  <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl p-6 text-center border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-1">4.9★</div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-10">
                  ...
                  <div className="bg-white rounded-2xl border-2 border-gray-100 p-8 shadow-sm hover:shadow-md transition-shadow">
                    <h4 className="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2">
                      <Shield className="w-5 h-5 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent" />
                      Licenses & Credentials
                    </h4>
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex items-start gap-3">
                        <Shield className="w-4 h-4 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mt-0.5 flex-shrink-0" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
                  <div className="space-y-4 text-center">
                    <h5 className="text-lg font-semibold text-gray-900 flex items-center justify-center gap-2">
                      <Users className="w-5 h-5 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent" />
                      Languages
                    </h5>
                    <div className="flex flex-wrap gap-2 justify-center">
                      <span className="inline-flex items-center px-4 py-2 rounded-full border-2 border-gray-200 bg-white text-sm text-gray-700 font-medium hover:border-blue-600 hover:text-blue-600 transition-colors">English</span>
                      <span className="inline-flex items-center px-4 py-2 rounded-full border-2 border-gray-200 bg-white text-sm text-gray-700 font-medium hover:border-blue-600 hover:text-blue-600 transition-colors">Gujarati</span>
                      <span className="inline-flex items-center px-4 py-2 rounded-full border-2 border-gray-200 bg-white text-sm text-gray-700 font-medium hover:border-blue-600 hover:text-blue-600 transition-colors">Hindi</span>
                    </div>
                  </div>
                  
                  <div className="space-y-4 text-center">
                    <h5 className="text-lg font-semibold text-gray-900 flex items-center justify-center gap-2">
                      <Target className="w-5 h-5 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent" />
                      Serving
                    </h5>
                    <div className="flex flex-wrap gap-2 justify-center">
                      <span className="inline-flex items-center px-4 py-2 rounded-full border-2 border-gray-200 bg-white text-sm text-gray-700 font-medium hover:border-blue-600 hover:text-blue-600 transition-colors">Canada</span>
                      <span className="inline-flex items-center px-4 py-2 rounded-full border-2 border-gray-200 bg-white text-sm text-gray-700 font-medium hover:border-blue-600 hover:text-blue-600 transition-colors">United States</span>
                    </div>
                  </div>
                  
                  <div className="space-y-4 text-center">
                    <h5 className="text-lg font-semibold text-gray-900 flex items-center justify-center gap-2">
                      <CheckCircle className="w-5 h-5 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent" />
                      Availability
                    </h5>
                    <div className="flex flex-wrap gap-2 justify-center">
                      <span className="inline-flex items-center px-4 py-2 rounded-full border-2 border-gray-200 bg-white text-sm text-gray-700 font-medium hover:border-blue-600 hover:text-blue-600 transition-colors">Virtual Meetings</span>
                      <span className="inline-flex items-center px-4 py-2 rounded-full border-2 border-gray-200 bg-white text-sm text-gray-700 font-medium hover:border-blue-600 hover:text-blue-600 transition-colors">In‑Person</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-indigo-600/10 rounded-full blur-2xl"></div>
