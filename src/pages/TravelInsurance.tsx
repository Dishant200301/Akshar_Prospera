    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[80vh] overflow-hidden pt-16 bg-black">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(/image/travel.jpg)',
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Why Choose Our <span className="bg-gradient-primary bg-clip-text text-transparent">Travel Insurance</span>?
            </h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Choose Your <span className="bg-gradient-primary bg-clip-text text-transparent">Travel Plan</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              What's Covered in Your <span className="bg-gradient-primary bg-clip-text text-transparent">Travel Insurance</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              <span className="bg-gradient-primary bg-clip-text text-transparent">Global</span> Coverage
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Need Help While <span className="bg-gradient-primary bg-clip-text text-transparent">Traveling</span>?
            </h2>
