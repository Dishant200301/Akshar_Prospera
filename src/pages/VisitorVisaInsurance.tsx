        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Visa Insurance for
              <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent"> Global Travelers</span>
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-4xl mx-auto">
            {visaTypes.map((visa, index) => (
              <div key={index} className="text-center bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-sm text-purple-600 font-medium">{visa.coverage}</p>
              </div>
            ))}
          </div>
        </div>
